const events = [
  ...
  },
  {
    ...
    description:
      "Vamos apresentar soluções tecnológicas para várias empresas do ramo de varejo.",
    date: new Date(2018, 6, 12, 10, 33, 30, 0),
    local: "São Paulo - SP",
    type: "Empresa",
    id: "101",
    image:
  ...
  },
  {
    ...
    description: "Venha ver os finalistas do show de talentos.",
    date: new Date(2018, 10, 15, 10, 33, 30, 0),
